module github.com/Jigsaw-Code/outline-sdk/x/examples/fetch-psiphon
...
replace (
	github.com/Jigsaw-Code/outline-sdk/x/psiphon => ../../psiphon
	github.com/Psiphon-Labs/psiphon-tunnel-core => github.com/adam-p/psiphon-tunnel-core v0.0.14-beta-ios.0.20240517195259-e260cfb89438
)

require (
	github.com/Jigsaw-Code/outline-sdk/x/psiphon v0.0.0-20240222204222-ff9ae687ed13
...
require (
	...
	github.com/Jigsaw-Code/outline-sdk v0.0.13 // indirect
